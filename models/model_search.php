...
class  model_search extends model
{
    ...
    function getProduct($exist, $keyword, $orderType1, $orderType2)
    {
        $string = ' where 1=1 ';
        $order = 'order by';
    ...
    function doSearch($data)
    {
        ...
        $products = $this->getProduct($exist, $keyword, $orderType1, $orderType2);
        ...
        $page_number = ceil(sizeof($productTotal) / $limit);
