<div id="main"
     style="width: 1200px;margin: 10px auto;height: 500px;background: #fff;box-shadow: 0 1px 3px #eee;border-radius: 4px;overflow: hidden">
    ...
    <div class="header">
        <i></i>
        <h2 class="yekan">ورود به سایت</h2>
