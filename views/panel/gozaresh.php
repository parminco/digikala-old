    ...
    <div class="content">
        <table>
            <tr>
                ...
                <td>
                    <span class="title">تعدا کل دیجی بن های دریافتی :</span>
                    <span class="value">-</span>
                </td>

                <td>
                    <span class="title">تعداد نظرات ارسال شده :</span>
                    <span class="value"><?= $Stat['comment_number'] ?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="value"><?= $Stat['order_pardazesh_number']; ?></span>
                </td>
                ...
                <td>
                    ...
                    <span class="value"><?= $Stat['message_number']; ?></span>
                </td>
